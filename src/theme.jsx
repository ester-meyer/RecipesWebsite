...
export default extendTheme({
          ...
          ...(ownerState.variant === 'outlined' && {
            [`&:not(.${inputClasses.focused}):hover::before`]: {
              boxShadow: `inset 0 0 0 2px ${
                theme.vars.palette && theme.vars.palette[ownerState.color] && theme.vars.palette[ownerState.color].outlinedBorder
              }`,
            },
          }),
        }),
  ...
  mixins: {
    toolbar: {
      minHeight: 64,  // או כל ערך שתצטרך עבור הגובה של ה-toolbar
    },
  },
});
